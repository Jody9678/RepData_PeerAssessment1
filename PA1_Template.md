...
Unzip data to obtain a csv file. echo=TRUE
...
1.  If you do not understand the difference between a histogram and a
    ...
    the total number of steps taken each day. echo=TRUE
...
1.  Which 5-minute interval, on average across all the days in the
    dataset, contains the maximum number of steps? echo=TRUE
...
1.  Devise a strategy to fill in all of the missing values of the
...
1.  Create a new dataset that is equal to the original dataset but with
    the missing data filled in. echo=TRUE
